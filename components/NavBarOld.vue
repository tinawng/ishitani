<template>
  <section>
    <div class="z-50 nav-container flex items-center justify-end">
      <h2 class="flex-grow text-left">ishitani furniture</h2>
      ...
      <div
        class="burger-container flex flex-col justify-center items-end"
